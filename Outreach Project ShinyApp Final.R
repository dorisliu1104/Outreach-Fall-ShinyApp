                            ...
                            tabPanel(h4("In the intertidal"),
                                     ...
                                     column(width = 12,
                                            ...
                                            box(title = h4(strong("Comprehension check"), align="center"),
                                                ...
                                                width = "50%",
                                                column(12, align="center",
                                                       h4("Examine the above photo of the shore crab (", em("Pachygraspus crasspies"), "). Describe two natural and two anthropogenic factors that affect the crab in the intertidal zone.")))),
                                     )),
                            ###
