                         ...
                         tabsetPanel(id="about_the_sites_tabs",
                                     tabPanel(h4("Background"),
                                              ...
                                              h5(p(em("California sea surface water temperature, by",
                                                      tags$a(href="https://www.ospo.noaa.gov/Products/ocean/sst/contour/", "National Oceanic and Atmospheric Administration"), "."))),
                                     ),
                                     ...
                                     tabPanel(h4("Methods"),
                                              ...
                                              h4(em("Take a look at",
                                                    tags$a(href="https://www.windy.com/?36.364,-121.838,7,i:pressure", "Windy.com"), "to explore more physical differences between these three sites and across the California coastline"))),
